...
//In Spring Data JPA è molto facile trovare i due tipi generici.
...
// che implementa BookRepository e che è annotata con @Repository
// *In realtà la class che implementa BookRepository non ha nome, ma il bean Spring
